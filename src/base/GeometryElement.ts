...
export class GeometryElement implements IEventEmitter {
    ...
    isDraggable: boolean;
    isReal: boolean;
    childElements: { [x: string]: unknown };
    hasLabel: boolean;
    highlighted: boolean;
    ...
    baseElement: GeometryElement | null;
    descendants: GeometryElement[];
    ancestors: GeometryElement[];
    parents: unknown[];
    symbolic: unknown;
    rendNode: unknown;
    elType: string;
    ...
    private _pos: number;
    stdform: number[];
    methodMap: { [name: string]: string };
    quadraticform: [[number, number, number], [number, number, number], [number, number, number]];
    visProp: unknown;
    visPropCalc: unknown;
    mouseover: boolean;
    lastDragTime: Date;
     ...
     * @private
     */
    updateVisibility(parent_val: boolean): this {
...
export function isGeometryElement(x: unknown): x is GeometryElement {
    return x instanceof GeometryElement;
}
